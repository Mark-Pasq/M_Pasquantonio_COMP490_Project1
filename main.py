...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self):
        ...
        self.lineEditSearchLocation.setStatusTip(_translate("MainWindow", "Enter a geographical location to search for here!"))
        ...
        self.lineEditSearchTechnology.setStatusTip(_translate("MainWindow", "Enter a technology, like Python, Java, "
